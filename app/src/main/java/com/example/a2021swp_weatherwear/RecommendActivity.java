        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                while (!isInterrupted()) {
                    ...
                    weather_data1 = getWeatherXmlData(getDate, getTime+2);
                    weather_data2 = getWeatherXmlData(getDate, getTime+4);
                    weather_data3 = getWeatherXmlData(getDate, getTime+6);
                    weather_data4 = getWeatherXmlData(getDate, getTime+8);
